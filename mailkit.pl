...
#
#  DESCRIPTION: A script that will allow for creating an monitoring of
...
#         BUGS: ---
#        NOTES: ---
#       AUTHOR: Deepankumar, Pandurangan
# ORGANIZATION:
#      VERSION: 1.0
#      CREATED: 01/01/2020
#     REVISION: ---
...
<html>
  <head>
    <title>Deepan's Mail Campaign</title>
  </head>
  <body>
    <h2>Greetings</h2>
